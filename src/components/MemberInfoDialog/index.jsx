    ...
    return <li key = {memberInfo.studentId} className={styles.memberItem} onClick={dialogOpen}>
        ...
        <div onClick={(e) => e.stopPropagation()}>
            <Dialog title='회원 정보' dialogRef={dialogRef} onClose={dialogClose}>
                ...
                <button className={styles.deleteButton} type='button' onClick={(e) => { e.stopPropagation(); handleDeleteMember(memberInfo); }} disabled={memberInfo.studentId === 'Loading...'} name='계정 삭제'>계정 삭제</button>
            </ Dialog>
        </div>
    </li>
}
